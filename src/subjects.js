...
export const english = {
  ...
  "Expressive Communication": {
    ...
    "Step 5": [
      ...
      "Says an appropriate word to complete a sentence when the adult pauses (e.g. 'We're going to the… zoo/ park/ shop/ beach').",
      "Makes attempts to repair misunderstandings without changing the words used e.g. by repeating a word with a different intonation or facial expression.",
      "Produces meaningful marks or symbols associated with their own name or familiar spoken words, actions, images or events e.g. contributing to records of their own achievements or to books about themselves, their families and interests.",
      "Traces, overwrites or copies shapes and straight line patterns including copying diagonal movements.",
      "Draws lines or shapes on a small or a large scale e.g. on paper, or in the air, or sand.",
      "Develops a preferred hand.",
      "Develops static tripod pencil grip or quadruped pencil grip.",
      "Draws a representation of a person, with limbs attached to a head.",
    ],
    "Step 4": [
      ...
      "Develops digital pronate pencil grip or splayed 4-finger pencil grip.",
